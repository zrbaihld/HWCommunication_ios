...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HWCommunication.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zrbaihld/HWCommunication'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zrbaihld' => '360599892@qq.com' }
  s.source           = { :git => 'https://github.com/zrbaihld/HWCommunication.git', :tag => s.version.to_s }
